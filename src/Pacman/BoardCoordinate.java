 ...
 * isTarget to true in the constructor's third parameter. You should *only* set
 * this parameter to true if, because of the game logic, you specifically want
 * to allow out of bounds squares to be created (essentially, only when creating
 * targets).
 *
...
public class BoardCoordinate {
	 ...
	 * bounded by 0 and the _ROW_MAX for the row and the _COL_MAX for the
	 * column, respectively.
	 *
